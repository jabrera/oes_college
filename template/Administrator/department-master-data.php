<div id="body-container">
	<div class="content">
		...
		<div class="wrapper">
				...
				<div class="card">
					...
					<table class="form-container" id="frmSearch">
						<tr>
							<td>
								<label>Search</label>
								<input type="text" name="search" placeholder="Department Name or Code"<?php if(isset($_POST['search'])) echo 'value="'.$_POST['search'].'"'; ?>>
							</td>
						</tr>
						<tr>
					...
					<script>
					function refreshListDepartment() {
						$checkedData = [];
						$("#numDataSelected").html("");
						showDataAction(false);
						
						$("#lstDepartment").html('<div class="card"><center><br><br><img src="images/skin/oslo/bg/loading.gif" /><br><br></center></div>');
						...
						$.ajax({
							type: "post",
							cache: true,
							url: "process.php?action=listdepartment",
							data: {p: $p, search: $search, pp: $pp, college: $college},
							success: function(html) {
								$("#lstDepartment").html(html)
							}
						});
					}
			...
			<div class="col-7" id="lstDepartment">
